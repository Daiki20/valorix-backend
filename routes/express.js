...
- Для тоталов (ТБ/ТМ), фор и других рынков — оцени реалистично как у топ-букмекеров`
    ...
    const betTypes = `  * Двойной шанс "1X" / "X2" (коэф ~1.20–1.55) — самый надёжный вариант
...
Требования:
- Выбирай ТОЛЬКО из матчей выше
- В поле "odds" ставь ТОЧНОЕ число из коэффициентов выше
- В поле "prediction" пиши тип ставки: "Победа хозяев (П1)", "Победа гостей (П2)", "Ничья (X)", "Двойной шанс (1X)", "Двойной шанс (X2)", "Тотал больше 2.5 (ТБ 2.5)", "Тотал меньше 2.5 (ТМ 2.5)", "Тотал больше 3.5 (ТБ 3.5)", "Тотал меньше 3.5 (ТМ 3.5)"
- Поля home/away/league — ТОЧНО как в списке выше
- ВСЕ текстовые поля — СТРОГО на русском языке
- НЕ ВЫБИРАЙ матчи без коэффициентов или с коэф=null
${oddsRequirement}
  ...
  "picks": [
    {
      ...
      "odds": 1.75,
      "reasoning": "2-3 предложения: почему этот исход надёжный, что говорят коэффициенты и статистика."
    }
  ],
  "total_odds": 2.85,
...
- Вероятность каждой ставки >70%, каждый коэф от 1.40 до 2.00`
