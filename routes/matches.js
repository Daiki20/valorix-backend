...
const RU_LOGO_MAP = {
  ...
  'эквадор':'Ecuador','парагвай':'Paraguay','боливия':'Bolivia',
  ...
  'словения':'Slovenia','черногория':'Montenegro','северная македония':'North Macedonia',
  'босния':'Bosnia and Herzegovina','латвия':'Latvia','литва':'Lithuania','эстония':'Estonia',
  'ирак':'Iraq','сирия':'Syria','иордания':'Jordan','оаэ':'United Arab Emirates',
  'китай':'China','индия':'India','таиланд':'Thailand','вьетнам':'Vietnam',
  'нигер':'Niger','мали':'Mali','буркина-фасо':'Burkina Faso','кот-д\'ивуар':'Ivory Coast',
  // ── РПЛ и российские клубы ───────────────────────────────────────────────────
  ...
  'ростов':'FC Rostov','крылья советов':'Krylia Sovetov','ахмат':'Akhmat Grozny',
  'урал':'FC Ural','пари нн':'Pari Nizhny Novgorod','нижний новгород':'FC Nizhny Novgorod',
  ...
  'боруссия дортмунд':'Borussia Dortmund','боруссия':'Borussia Dortmund',
  'ювентус':'Juventus','интер':'Inter Milan','интер милан':'Inter Milan',
  'милан':'AC Milan','ак милан':'AC Milan','наполи':'Napoli',
  'псж':'PSG','пsg':'PSG','пари сен-жермен':'PSG',
  'атлетико':'Atletico Madrid','атлетико мадрид':'Atletico Madrid',
  'севилья':'Sevilla','валенсия':'Valencia','бетис':'Real Betis','вильярреал':'Villarreal',
  'аякс':'Ajax','порту':'Porto','бенфика':'Benfica','спортинг':'Sporting CP',
  'шахтёр':'Shakhtar Donetsk','шахтер':'Shakhtar Donetsk','динамо киев':'Dynamo Kyiv',
  'лейпциг':'RB Leipzig','байер':'Bayer Leverkusen','айнтрахт':'Eintracht Frankfurt',
...
function getLeagueScore(sport, leagueName) {
  ...
  if (sport === 'football') {
    ...
    if (/чм\s*20\d\d|чемпионат мира|world cup|мундиаль/i.test(l))          return 1000
